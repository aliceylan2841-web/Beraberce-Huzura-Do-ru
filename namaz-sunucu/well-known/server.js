...
const fetch    = require('node-fetch'); // AI isteği için eklendi
...
Eğer başlık tanınmıyorsa veya emin değilsen, {"error":"bulunamadı"} döndür. Metinleri uydurma, sadece kesin bildiğin, doğru ve yaygın kabul gören metinleri ver.`;
    ...
    // NOT: gemini-2.0-flash, gemini-1.5-flash(-latest) ve gemini-pro
    // artık tamamen kapatıldı (404 döner), bu yüzden listede yok.
